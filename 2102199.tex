...
\title{Momentum Quantifier (MoQ): Proving the "Big Mo" is Real}  % 标题
...
% 请将以下两行的注释号 '%' 去除，以使其生效
\vspace{15pt}  %mm	毫米	1 mm = 2.845 pt   pt 点	1 pt = 0.351 mm；此处为Keywords与Abstract正文额外相隔的距离（1.5cm）
...
\begin{figure}[htbp]  %h此处，t页顶，b页底，p独立一页，浮动体出现的位置
	\centering  %图表居中
	\includegraphics[width=.76\textwidth]{sliding-window.png} %图片的名称或者路径之中有空格会出问题 
...
\begin{figure}[htbp]  %h此处，t页顶，b页底，p独立一页，浮动体出现的位置
	\centering  %图表居中
	\includegraphics[width=0.8\textwidth]{momentum-model.png} %图片的名称或者路径之中有空格会出问题 
...
\begin{figure}[htbp]  %h此处，t页顶，b页底，p独立一页，浮动体出现的位置
	\centering  %图表居中
	\includegraphics[width=.8\textwidth]{work.png} %图片的名称或者路径之中有空格会出问题 
	\caption{Journey Map of Our Work} % 图片标题 
\end{figure}
\vspace{-0.8cm}
...
\end{tabular}\label{tb:notation}
 \begin{tablenotes}
        \footnotesize
        \item[*] *Additional variables that not listed here will be discussed in detail in their corresponding section. %此处加入注释*信息
      \end{tablenotes}
\end{center}
\end{table}
...
\begin{table}[htbp]
	...
	\resizebox{0.35\textwidth}{!}{% Ensure this scales the table appropriately
		\begin{tabular}{cc} % You can use 'c' alignment since you're centering all cells
			\toprule[2pt]
			\multicolumn{1}{m{2cm}}{\centering \textbf{Actual}} &
			\multicolumn{1}{m{3cm}}{\centering \textbf{Predicted}} \\
			\midrule
			12 & 1.574508666  \\
			12 & 1.381220818 \\
			-10 & -0.544439316 \\
...
\begin{table}[htbp]
	...
	\resizebox{0.5\textwidth}{!}{% Ensure this scales the table appropriately
		\begin{tabular}{cc} % You can use 'c' alignment since you're centering all cells
			\toprule[2pt]
			\multicolumn{1}{m{4cm}}{\centering ace\_count\_average} &
			\multicolumn{1}{m{4cm}}{\centering \textbf{Round}} \\
			\midrule
			$10.0625$ & 1/16\\
			$14$ & 1/8 \\
			$13$ & 1/4 \\
...
\begin{figure}[htbp]  %h此处，t页顶，b页底，p独立一页，浮动体出现的位置
	\centering  %图表居中
	\includegraphics[width=0.85\textwidth]{corrected.png} %图片的名称或者路径之中有空格会出问题 
	\caption{\centering Comparison between Actual and MoQ model prediction result without \& without incorporating the Round factor, at the First Match of the 16/1 Round.} % 图片标题 
\end{figure}
\vspace{-0.2cm}
...
\begin{figure}[htbp]  %h此处，t页顶，b页底，p独立一页，浮动体出现的位置
	\centering  %图表居中
	\includegraphics[width=0.85\textwidth]{new.png} %图片的名称或者路径之中有空格会出问题 
	\caption{Prediction Result of Adapted MoQ on ATP 2019 Men's Final} % 图片标题 
\end{figure}
\vspace{-0.2cm}
...
\begin{thebibliography}{99}
	...
	\bibitem{16} \href{https://www.kaggle.com/datasets/robseidl/tennis-atp-tour-australian-open-final-2019}{Kaggle | Tennis ATP Tour Australian Open Final 2019}
	\bibitem{17} \href{https://kns.cnki.net/kcms2/article/abstract?v=-0THPtffOh0bQVlHVveBVTVKK1xaOhfEEwEGfcv0Ri8tdLgkqDPfzYfnNHJrYp-q0S8EWmzQPrPqy3KWqVWK-Gz-sHas1SAdT6n64JOD8XYzscwWreE7MjTzFXMPUTkQchdeqW0j10DPxHxNslquvERQIZ21ZAXiAn9DCD-5hTg=&uniplatform=NZKPT&language=CHS}{Zhu Mingquan, School of Physical Education, China University of Geosciences (Wuhan). Stability of World Excellent Men's Speed Climbing Performance}
	\bibitem{18} \href{http://www.woc88.com/d-115024857.html}{Exploring the Characteristics and Trends of Competitive Performance in Multi round and Multi round Racing Programs (Athletics Thesis)}
